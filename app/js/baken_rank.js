function calculateRank() {
    ...
    resultRank = resultrankJudge(returnRateDiff + hitRateDiff);
    ...
    // test項目
    hitRateDeviation.innerHTML = `${Math.round(hitRateDiff * 100) / 100}`;
    returnRateDeviation.innerHTML = `${Math.round(returnRateDiff * 100) / 100}`;
